...
export class ViewAllProductsComponent implements OnInit {
  ...
  //       return product.brand.toLowerCase().indexOf(this.searchText) != -1 || product.name.toLowerCase().indexOf(this.searchText) != -1 || product.category.toLowerCase().indexOf(this.searchText) != -1
  //     });
  //   } else {
  //     this.productListToDisplay = this.productList;
  //   }
